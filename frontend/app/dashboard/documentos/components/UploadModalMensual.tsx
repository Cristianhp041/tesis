...
interface UploadModalMensualProps {
  isOpen: boolean;
  onClose: () => void;
  onUpload: (file: File, formData: DocumentFormData) => Promise<void>;
}

export default function UploadModalMensual({ 
  isOpen, 
  onClose, 
  onUpload 
}: UploadModalMensualProps) {
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition">
              <input
                ...
                className="hidden"
                id="file-upload-mensual"
                disabled={uploading}
              />
              <label htmlFor="file-upload-mensual" className="cursor-pointer">
                {file ? (
