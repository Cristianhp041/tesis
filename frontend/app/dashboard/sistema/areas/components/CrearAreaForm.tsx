...
import { CREATE_AREA } from "../graphql/createArea";
...
export default function CrearAreaForm({ onSuccess, onCancel }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        if (errorMessage.includes("Ya existe un área con ese nombre")) {
