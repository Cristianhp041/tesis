...
export interface SubclasificacionFilterState {
  search: string;
  activo: boolean | undefined;
}

interface Props {
  value: SubclasificacionFilterState;
  onChange: (value: Partial<SubclasificacionFilterState>) => void;
}

export default function SubclasificacionFilters({ value, onChange }: Props) {
  const clearFilters = () => {
    onChange({
      search: "",
      activo: undefined,
